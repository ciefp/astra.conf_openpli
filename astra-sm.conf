...
f11761hcy = make_t2mi_decap({
        ...
        input = "http://127.0.0.1:8001/1:0:1:66:3EA:FFFF:1860000:0:0:0:",
        plp = 0,
        pnr = 0,
        pid = 4096,
    })
    make_channel({
        ...
        output = { "http://0.0.0.0:9999/test/a33", },
    })

-- DTTCy 11778 H 15155 39.0E 4096
f11778hcy = make_t2mi_decap({
        name = "11778H T2-MI PLP0",
        input = "http://127.0.0.1:8001/1:0:1:3EA:3EA:0:1862E02:0:0:0:",
        plp = 0,
        pnr = 0,
        pid = 4096,
    })
    make_channel({
        ...
        output = { "http://0.0.0.0:9999/test/a44", },
    })